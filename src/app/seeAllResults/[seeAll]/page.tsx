...
//   const [movieData, results] = await Promise.all([
//     fetchFromSeeAllResultsMovieDB(seeAll, String(currentPage)),
//   ]);
...
//   return (
//     <div className="w-screen mb-60 flex gap-10 max-sm:flex-col-reverse">
...
//         )}
//       </div>
//       <div className="w-[20vw] mr-50 mt-10 max-sm:flex max-sm:flex-row max-sm:w-[90vw] max-sm:mr-0 max-sm:ml-10">
//         <BadgeDemo />
//       </div>
//       {totalPages > 1 && (
